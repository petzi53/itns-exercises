...
### Installing and loading R packages {#packages-03}
...
### Theme adaption for the graphic display with `ggplot2` {#theme-03}
...
## Working with the oiginal Excel file
